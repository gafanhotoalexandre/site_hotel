...
<head>
    ...
    <!-- Font Awesome -->
    <script src="https://kit.fontawesome.com/5e5fac4a54.js" crossorigin="anonymous"></script>
...
<body>
    ...
    <script>
        ...
        {
            if (action === 'view') {
                location.href = 'personal_record.php?act=view'
            }
            if (action === 'edit') {
                location.href = 'personal_record.php'
            }
        }
